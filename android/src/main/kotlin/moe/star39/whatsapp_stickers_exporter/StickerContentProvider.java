...
import static moe.star39.whatsapp_stickers_exporter.ConfigFileManager.CONTENT_FILE_NAME;
...
public class StickerContentProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        final String authority = WhatsappStickersExporterPlugin.getContentProviderAuthority(getContext());
...
//        }
    ...
    public String getType(@NonNull Uri uri) {
        ...
        switch (matchCode) {
            case METADATA_CODE:
                return "vnd.android.cursor.dir/vnd." + WhatsappStickersExporterPlugin.getContentProviderAuthority(context) + "." + METADATA;
            case METADATA_CODE_FOR_SINGLE_PACK:
                return "vnd.android.cursor.item/vnd." + WhatsappStickersExporterPlugin.getContentProviderAuthority(context) + "." + METADATA;
            case STICKERS_CODE:
                return "vnd.android.cursor.dir/vnd." + WhatsappStickersExporterPlugin.getContentProviderAuthority(context) + "." + STICKERS;
