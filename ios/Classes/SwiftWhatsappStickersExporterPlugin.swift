...
public class SwiftWhatsappStickersExporterPlugin: NSObject, FlutterPlugin {
	private var registrar: FlutterPluginRegistrar?
	
	public static func register(with registrar: FlutterPluginRegistrar) {
		let channel = FlutterMethodChannel(name: "whatsapp_stickers_exporter", binaryMessenger: registrar.messenger())
		let instance = SwiftWhatsappStickersExporterPlugin()
	...
	public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
		...
		guard let stickers = arguments["stickers"] as? [[String]] else {
