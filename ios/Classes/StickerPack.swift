...
class StickerPack {
	 ...
	 */
	init(identifier: String, name: String, publisher: String, trayImageFileName: String, animatedStickerPack: Bool?,
	     publisherWebsite: String?, privacyPolicyWebsite: String?, licenseAgreementWebsite: String?) throws {
		...
		self.animatedStickerPack = animatedStickerPack ?? false
	 ...
	 *  - Throws:
	 ...
	 - .incorrectImageSize if the tray image is not within the allowed size
	 */
	init(identifier: String, name: String, publisher: String, trayImagePNGData: Data,animatedStickerPack: Bool?,
	     publisherWebsite: String?, privacyPolicyWebsite: String?, licenseAgreementWebsite: String?) throws {
		guard !name.isEmpty && !publisher.isEmpty && !identifier.isEmpty else {
			throw StickerPackError.emptyString
		}
